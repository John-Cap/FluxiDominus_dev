...
if __name__ == "__main__":
    ...
    #IR
    _IR=(IR(volume=1,inlets=[],outlets=[],name="IR",slugs=[]))
    #TPiece
    ...
    def run_code():
        ...
        while running:
            ...
            while not (_slug.tailHost is _currTerminus):
                ...
                print("Front: " + str(
                    _slug.frontHost.name) + ", " + str(round(_slug.frontHostPos, 1)) + "/" + str(
                    _slug.frontHost.volume) + " mL, Tail: " + str(_slug.tailHost.name) + ", " + str(
                    round(_slug.tailHostPos, 1)) + "/" + str(_slug.tailHost.volume) + " mL, fr: " + str(
                    round(_slug.frontHost.flowrateOut*60, 1)) + " mL/min, slug vol: " + str(
                    round(_vol, 1)) + " mL, collected: " + str(round(_slug.collectedVol, 1)) + " mL")
            ...
            print("************")
            print("************")
            print("Slug took " + str(time.perf_counter() - _now) + " seconds to collect")
            print("Collected slug volumes:")
            for _x in _path.collectedSlugs:
                print(str(round(_x.collectedVol,2)) + " mL")
            print("************")
            print("************")
