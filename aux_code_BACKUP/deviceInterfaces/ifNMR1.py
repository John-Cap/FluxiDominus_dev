                            ...
                            if json_data:
                                ...
                                for message in jsonFromXML:
                                    ...
                                    if "CheckShimResponse" in message:
                                        ...
                                        device_info["tele"]["state"]["shim"]["check"]["response"]["stableTemp"] = eval(message["CheckShimResponse"]["StableTemperatures"])
                                    ...
                                    if "PowerShimResponse" in message:
                                        ...
                                        device_info["tele"]["state"]["shim"]["power"]["response"]["operatingTemp"] = eval(message["PowerShimResponse"]["OperatingTemperature"])
                                        device_info["tele"]["state"]["shim"]["power"]["response"]["stableTemp"] = eval(message["PowerShimResponse"]["StableTemperatures"])
